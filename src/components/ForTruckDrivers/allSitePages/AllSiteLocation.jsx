        ...
        <div className="flex flex-wrap justify-between w-full">
            <div className="lg:w-1/2 pe-16">
              ...
              <p className="font-normal font-Poppins opacity-70 text-base">
                ...
                aenean nisl in augue. Quisque egestas dolor aliquet sed. Dictum
                at commodo velit etiam tincidunt metus massa massa. Purus diam
                risus eget dapibus at
              </p>
            </div>
            <div className="lg:w-1/2">
              ...
              <button className="px-[51px] h-[49px] py-[12px] text-white text-base font-semibold  mt-[53px] bg-primary rounded-[10px]">
                Book Now
              </button>
            </div>
          </div>
