        ...
        <div className="container">
          ...
          <div className="flex">
            <div className=" lg:w-1/2">
              <img src={man_with_truck} alt="man_with_truck" className='w-full'/>
            </div>
            <div className="lg:w-1/2">
              <h4 className=' text-black text-md font-bold'>TLDR - Here's what you need to know:</h4>
              <ul>
                <li className=' mb-4 text-base font-normal opacity-60 text-black'>
